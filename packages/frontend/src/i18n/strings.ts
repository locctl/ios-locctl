// Central string table for ios-locctl.
...
export const STRINGS = {
  ...
  'move.bicycling': { zh: '腳踏車', en: 'Bicycling' },
  ...
  'wifi.repair_confirm_body': { zh: '此動作會用 USB 重建 RemotePairing 記錄。過程中 iPhone 可能會跳「信任這台電腦」,請解鎖並按信任。ios-locctl 必須以 sudo 身分執行。\n\n確定要繼續嗎?', en: 'This rebuilds the RemotePairing record via USB. Your iPhone may show "Trust This Computer", unlock it and tap Trust. ios-locctl must be running with sudo.\n\nContinue?' },
  ...
  'wifi.tunnel_admin_hint': { zh: '請使用 sudo 開啟 ios-locctl,必須先通過 USB 信任。', en: 'Run ios-locctl with sudo. Device must be paired via USB first.' },
  ...
  'bm.country_placeholder': { zh: '國家 / 地區', en: 'Country / region' },
